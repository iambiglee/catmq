package com.baracklee.ui.job;

import com.baracklee.mq.biz.common.SoaConfig;
import com.baracklee.mq.biz.common.util.EmailUtil;
import com.baracklee.mq.biz.polling.AbstractTimerService;
...
public class QueueWarningInfoService extends AbstractTimerService {
    ...
    public QueueWarningInfoService(UiQueueService uiQueueService,
    ...
    public void dostart() {
        ...
        int mailSendTime = Integer.parseInt(environment.getProperty("queue.warning.mail.time", "8"));
        // 提前触发,
    ...
    private void doChceck(int dataSize, int tableRows) {
        ...
        List<QueueVo> queueForReportDataList = new ArrayList<>();
        List<QueueVo> QueuesWithExpiredMessageList = new ArrayList<>();
