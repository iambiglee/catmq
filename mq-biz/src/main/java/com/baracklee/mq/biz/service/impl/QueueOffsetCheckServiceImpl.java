...
public class QueueOffsetCheckServiceImpl implements RedundanceCheckService {
    ...
    @Autowired
    public QueueOffsetCheckServiceImpl(QueueOffsetService queueOffsetService, TopicService topicService,
                                       QueueService queueService, ConsumerGroupService consumerGroupService,
